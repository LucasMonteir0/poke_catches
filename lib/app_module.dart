...
class AppModule implements Module {
  ...
  void binds(Injector i) {
    ...
    i.addLazySingleton<PokemonDatasource>(PokeApiDatasourceImpl.new);
    i.addLazySingleton<PokemonRepository>(PokemonRepositoryImpl.new);
    i.addLazySingleton<GetAllPokemonsUseCase>(GetAllPokemonsUseCaseImpl.new);
  }
